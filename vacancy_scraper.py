...
try:
    ...
    for page in range(pages_for_scrap):
        ...
        for vac in ordinary_vacancies:
            ...
            vac_features["vac_id"] = int(vac.find("div", {"class": "vacancy-serp-item__info"}).find("a")["href"].\
                                                split("/")[-1].split("?")[0])
    ...
    if pages_sj is not None:
        ...
        for page in range(1, pages_for_scrap + 1):
            ...
            for vac in vacancies:
                ...
                vac_features["vac_id"] = int(vac.find("div", {"class": "_3mfro PlM3e _2JVkc _3LJqf"}).find("a")["href"].\
                                                    split("-")[-1].split(".")[0])
